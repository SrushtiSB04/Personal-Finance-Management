...
public class Personal_finance_management extends javax.swing.JFrame {
    public Personal_finance_management() {
        initComponents();
        displayCategory();
    ...
    private void getEntries(){
        try{
            ...
            while(rs.next()){
                ...
                total+=t;
                Object o[]={rs.getInt("sid"),rs.getDate("date"),rs.getString("category"),rs.getInt("amount"),t};
                dtm.addRow(o);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Personal_finance_management");
        ...
        jLabel9.setText("Monthly Expense:");
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/extrafiles/1search.png"))); // NOI18N
        jMenuItem2.setText("View Spending");
        ...
        jMenu20.add(jSeparator1);

        jMenu21.setText("More");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            if(dt!=null && !s1.equals("") && !c.equals("")){
                ...
                JOptionPane.showMessageDialog(null,"Exspense Added Successfully!"); 
                getEntries();
            }else{
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        JOptionPane.showMessageDialog(null,"Designed and Developed by Srushti S.B"); 
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        System.exit(0);//successful termination of app
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Personal_finance_management.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Personal_finance_management().setVisible(true);
            }
        });
    }
