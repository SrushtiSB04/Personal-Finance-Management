...
public class ViewSpending extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("View Spending Date Wise");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {d1, jLabel1});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton2, jLabel3, totalAmount1});

        jPanel3.setBackground(new java.awt.Color(255, 204, 255));

        jButton3.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jButton3.setText("View Spending Category Wise");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        ResultSet rs=db.DbConnect.st.executeQuery("select * from spendings where date>=' "+dt1+"' and date<='"+dt2+"' and category='"+c+"'order by date asc");
        int total=0;
        while(rs.next()){
            int t=rs.getInt("amount");
            total+=t;
